...
{{< figure src="attachments/d48521bc-861b-4050-82df-1366d6bc01d2.png" alt="Diagram showing a Starlink user terminal connecting by encrypted radio to a satellite, then through a ground gateway to the internet" caption="Basic Starlink network architecture" >}}
...
{{< figure src="attachments/62ba1b39-218f-4887-9dab-7957d3f342fe.png" alt="Map showing a Starlink user terminal in Ukraine reaching gateways in Poland and Lithuania through satellites and inter-satellite links" caption="Starlink connectivity from Ukraine through neighboring gateways" width="594" height="434" >}}
...
{{< figure src="attachments/7beb1f43-a758-4a5c-ad1e-73fc65157927.png" alt="Disassembled Starlink Standard Actuated Rev3 antenna showing the full green printed circuit board inside its enclosure" caption="Starlink Rev3 antenna PCB" >}}
...
{{< figure src="attachments/49fe99e2-633f-46a8-82b4-d5dc91fcdb49.png" alt="Annotated close-up of the Starlink Rev3 PCB identifying the RF front-end, beamforming IC, PoE connector, disabled UART, STSAFE-A110, Cortex-A53 SoC, DRAM, removed eMMC, and GPS module" caption="Starlink Rev3 PCB core area" width="2070" height="775" >}}
...
{{< figure src="attachments/80819cd3-d929-4e20-a1e9-77f65b3ccb33.png" alt="Directory tree of the extracted Starlink firmware showing the sx/local/runtime bin, dat, and revision_info entries alongside scripts and proxy" caption="Starlink user terminal runtime directory" >}}
...
{{< figure src="attachments/91f681b3-25c3-4487-a2db-518aedba9a22.png" alt="GDB session in a QEMU environment paused at a breakpoint while debugging the ARM64 user_terminal_frontend process" caption="Debugging `user_terminal_frontend` in QEMU" >}}
...
{{< figure src="attachments/a451b9c1-5be5-4d8f-a77a-f17edef85653.png" alt="Terminal output for file_edr help describing the Ethernet Data Recorder as collecting selected network telemetry flows for later ground transmission" caption="Ethernet Data Recorder help output" >}}
